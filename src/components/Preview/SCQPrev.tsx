...
function SCQPrev() {
    ...
    return (
        <>
            {(!!test?.question?.content?.english) && <p>{parse(test?.question.content?.english)}</p>}
            {(!!test?.question?.bilingual_options?.english) && <div className='TFPrev'>
            ...
            {(!!test.question?.solutions[0].english.text) && <div className='Hint-Prev-box'>
                <h4>Solution</h4>
